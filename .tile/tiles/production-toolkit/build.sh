...
cp "${SRC_DIR}/${STAGES_DIRECTORY}"/stage0.tf "${WORKSPACE_DIR}"
cp "${SRC_DIR}/${STAGES_DIRECTORY}"/stage1-cluster.tf "${WORKSPACE_DIR}"
cp "${SRC_DIR}/${STAGES_DIRECTORY}"/stage3*.tf "${WORKSPACE_DIR}"
cp "${SRC_DIR}/${STAGES_DIRECTORY}"/catalog/stage4-cloud_object_storage.tf "${WORKSPACE_DIR}"
cp "${SRC_DIR}/${STAGES_DIRECTORY}"/catalog/stage4-watson-assistant.tf "${WORKSPACE_DIR}"
