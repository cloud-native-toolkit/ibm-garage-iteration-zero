...
helpFunction()
{
   ...
   echo -e "\033[1;31mUsage:\033[0m $0 IBMCLOUD_API_KEY IAAS_USERNAME IAAS_API_KEY"
   echo -e "  where \033[1;32mIBMCLOUD_API_KEY\033[0m is the IBM Cloud API key"
   echo -e "        \033[1;32mIAAS_USERNAME\033[0m is the IaaS Classic Infrastructure user name or API user name (e.g. 282165_joe@us.ibm.com)"
   echo -e "        \033[1;32mIAAS_API_KEY\033[0m is the IaaS Classic Infrastructure API key"
...
if [[ -z "${IBMCLOUD_API_KEY}" ]] || [[ -z "${IAAS_USERNAME}" ]] || [[ -z "${IAAS_API_KEY}" ]]
then
