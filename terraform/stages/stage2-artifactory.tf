module "dev_serviceaccount_artifactory" {
  source = "github.com/ibm-garage-cloud/garage-terraform-modules.git//cluster/serviceaccount?ref=v1.0.5"
...
module "dev_tools_artifactory_release" {
  source = "github.com/ibm-garage-cloud/garage-terraform-modules.git//tools/artifactory_release?ref=v1.0.5"
