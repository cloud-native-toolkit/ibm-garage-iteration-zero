module "dev_tools_ibm_image_registry" {
  source = "github.com/ibm-garage-cloud/terraform-ibm-image-registry.git?ref=v1.4.0"
...
module "dev_tools_ocp_image_registry" {
  source = "github.com/ibm-garage-cloud/terraform-ocp-image-registry.git?ref=v1.4.0"
