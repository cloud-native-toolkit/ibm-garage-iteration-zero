module "dev_tools_tekton_release" {
  source = "github.com/ibm-garage-cloud/garage-terraform-modules.git//generic/tools/tekton_release?ref=v2.2.0"
...
module "dev_tools_tekton_resources" {
  source = "github.com/ibm-garage-cloud/garage-terraform-modules.git//generic/tools/tekton_resources?ref=v2.2.0"
